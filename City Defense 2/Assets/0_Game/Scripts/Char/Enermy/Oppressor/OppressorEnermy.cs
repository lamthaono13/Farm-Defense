...
public class OppressorEnermy : Enermy
{
        ...
        switch (stateChar)
        {
            ...
            case StateChar.Attack:
                ...
                if (currentTimeAnimation >= speedAttack)
                {
                    ...
                    render.Animation.Animate(TypeAnimation.Attack, speedAttack / render.Animation.GetTimeAnimation(TypeAnimation.Attack, false), true, () => { weapon.Attack(target); }, () => { ChangeState(StateChar.Attack); });
