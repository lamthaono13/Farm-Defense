...
public static class NativeAdsMessenger
{
    static List<INativeADViewCallback> observers = new List<INativeADViewCallback>();
    public static void DestroyView()
    {
        for (int i = 0; i < observers.Count; i++)
        {
            observers[i].DestroyView();
        }
    }
    public static void AddListener(INativeADViewCallback listener)
    {
        observers.Add(listener);
    }
    public static void RemoveListener(INativeADViewCallback listener)
    {
